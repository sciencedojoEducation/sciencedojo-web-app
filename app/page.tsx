    ...
    <main className="min-w-0 flex-1 bg-white">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-8 lg:grid-cols-[1.12fr_.88fr] lg:gap-12">
          <div>
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              {showAssessment && <BookAssessmentLink source="homepage_hero" className="inline-flex min-h-12 items-center justify-center rounded-xl bg-white px-5 py-3 text-center text-sm font-extrabold text-[#073a72] shadow-lg transition hover:bg-cyan-50 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white">Request a free assessment <ArrowRight className="ml-2 h-4 w-4" aria-hidden="true" /></BookAssessmentLink>}
      ...
      <section className="bg-[linear-gradient(125deg,#073a72,#0066cc)] px-4 py-14 text-white md:px-8 md:py-16" aria-labelledby="next-step-heading">
        <div className="mx-auto flex max-w-6xl flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap gap-3">{showAssessment && <BookAssessmentLink source="homepage_final" className="inline-flex min-h-12 items-center justify-center rounded-xl bg-white px-5 py-3 text-sm font-extrabold text-[#073a72] hover:bg-cyan-50">Request a free assessment</BookAssessmentLink>}{showPractice && <Link href="/ai-practice-studio#studio" className="inline-flex min-h-12 items-center justify-center rounded-xl border border-white/60 px-5 py-3 text-sm font-extrabold hover:bg-white/10">Try free practice</Link>}</div>
        </div>
      </section>
    </main>
  );
