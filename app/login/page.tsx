  ...
  return (
    ...
    >
      <div className="space-y-2.5 md:space-y-6">
        {successMsg && (
          <div className="rounded-2xl border border-mint/20 bg-mint/10 p-3 text-center text-[10px] font-black uppercase tracking-wider text-mint animate-in fade-in zoom-in-95 md:p-4">
             {successMsg}
          </div>
        )}
        ...
        <button 
          ...
          className="group relative flex w-full transform items-center justify-center gap-2.5 overflow-hidden rounded-[1.25rem] border border-navy/5 bg-white py-3 shadow-lg shadow-navy/5 transition-all hover:border-navy/10 hover:shadow-navy/10 active:scale-95 md:gap-4 md:rounded-[2rem] md:py-5 md:shadow-xl"
        >
          ...
          <span className="text-sm font-black text-navy">Continue with Google</span>
          <motion.div 
