...
export default async function TutorAcademyQuizPage() {
  ...
  if (course.rules?.requireFinalAssessment === false)
    redirect("/dashboard/tutor/academy");
    ...
    <div className="px-6 py-12 sm:px-10 sm:py-16">
      <div className="mx-auto max-w-[728px]">
        <header className="border-b border-[#DEDFE1] pb-10">
          ...
          <h1 className="mt-3 text-[32px] font-bold leading-[1.2] tracking-[-0.025em] text-[#101010] sm:text-[40px] sm:leading-[48px]">
            Show what you know.
          </h1>
          ...
          <div className="mt-5 flex flex-wrap gap-4 text-[11px] font-bold uppercase tracking-[0.1em] text-[#717376]">
            <span className="inline-flex items-center gap-2">
              <CheckCircle2 size={15} /> 10 questions
            </span>
          ...
          {completed ? (
            <section className="border-y border-[#DEDFE1] py-10 text-center">
              ...
              <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
                ...
                <Link
                  href={`/dashboard/tutor/academy/lessons/${course.lessons[0].slug}`}
            ...
            <section className="border-l-4 border-[#C4943F] bg-[#FBF7EE] p-7 text-center sm:p-9">
              ...
              <Link
                href={`/dashboard/tutor/academy/lessons/${firstIncomplete.slug}`}
                className="mt-6 inline-flex min-h-11 items-center justify-center bg-[#59451F] px-7 text-xs font-bold uppercase tracking-[0.1em] text-white"
              >
                Continue course
              </Link>
            </section>
        ...
        <Link
          ...
          className="mt-8 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.1em] text-[#717376] hover:text-[#1E5AA8]"
        >
