        ...
        return (
            <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in pt-8 pb-12">
                ...
                <div className="bg-white rounded-[2rem] p-10 border border-slate-200 shadow-xl">
                    <h1 className="text-3xl font-black text-slate-800 mb-2">Review: {activeReview.mission_blueprint?.topic}</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                        <div>
                            <h3 className="font-black uppercase tracking-widest text-xs text-emerald-500 mb-4">AI Suggested Grade</h3>
                        ...
                        <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200">
                            <h3 className="font-black uppercase tracking-widest text-xs text-indigo-500 mb-4">AI Grader Notes</h3>
                            <p className="text-slate-700 italic">"{activeReview.ai_evaluation?.tutorFeedbackSummary}"</p>
                            
                            <h3 className="font-black uppercase tracking-widest text-xs text-red-500 mt-6 mb-2">Weak Topics Flagged</h3>
                    ...
                    <div className="space-y-6">
                       <h3 className="font-black uppercase tracking-widest text-xs text-slate-400 border-b border-slate-100 pb-2">Student Raw Inputs</h3>
                       <div>
                           <p className="text-[10px] font-black uppercase text-slate-500 mb-1">Stage 2: Specialist (Logic)</p>
                           <p className="bg-slate-50 p-4 rounded-xl text-slate-800 text-sm">{activeReview.student_answers?.s2 || "None"}</p>
                       </div>
                       <div>
                           <p className="text-[10px] font-black uppercase text-slate-500 mb-1">Stage 3: Architect (Application)</p>
                    ...
                    >
                        <CheckCircle2 size={20} /> Approve & Publish Grade
                    </button>
                    <p className="text-center text-xs text-slate-400 mt-4 font-medium">Approving will permanently log this score to the student's Classroom Analytics graph.</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in pt-8 pb-12">
            <div className="flex items-center gap-4 mb-10">
                ...
                <div>
                    <h1 className="text-4xl font-black text-slate-800 tracking-tight">Mission Inbox</h1>
                    <p className="text-slate-500 font-medium text-lg">Review and approve your students' AI-graded missions.</p>
                </div>
            </div>
            ...
            <div className="space-y-4">
                    ...
                    <div key={m.id} className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between hover:shadow-md transition-shadow cursor-pointer" onClick={() => setActiveReview(m)}>
                        ...
                        <div className="flex items-center gap-6">
                            <div className="text-right">
                                <p className="text-[10px] uppercase font-black tracking-widest text-emerald-500">AI Score</p>
                ...
                {missions.length === 0 && (
                    <div className="text-center py-20 border-2 border-dashed border-slate-200 rounded-[2rem] text-slate-400">
                        ...
                        <h3 className="text-xl font-black text-slate-600 mb-2">Inbox Zero</h3>
                        <p className="font-medium text-slate-500">No pending student missions found.</p>
                    </div>
                )}
            </div>
        </div>
