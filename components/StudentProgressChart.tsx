...
export default function StudentProgressChart({ bookings }: StudentProgressChartProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
      ...
      <div className="lg:col-span-2 bg-white p-6 md:p-8 rounded-[2rem] border border-secondary/10 shadow-sm">
        <h3 className="text-secondary font-black text-xl mb-6 flex items-center gap-3">
      ...
      {/* Subjects Pie Chart */}
      <div className="bg-white p-6 md:p-8 rounded-[2rem] border border-secondary/10 shadow-sm flex flex-col">
        <h3 className="text-secondary font-black text-xl mb-6 flex items-center gap-3">
