...
export function HomeTutorDirectorySkeleton() {
  return (
    <section aria-label="Loading verified expert tutors" className="w-full bg-white px-4 py-16 md:px-10 md:py-36">
      ...
      <div className="mx-auto max-w-[1360px]">
        ...
        {tutors.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-secondary/10 bg-white py-20 text-center shadow-sm">
            ...
            <Link href="/" className="mt-6 rounded-lg border border-primary/20 px-4 py-2 font-medium text-primary transition-colors hover:bg-primary/5">
              Clear Filters
            </Link>
          </div>
        )}
